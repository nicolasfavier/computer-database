...
insert into computer (id,name,introduced,discontinued,company_id) values ( 20,'colas II','1977-01-01',null,4);
insert into computer (id,name,introduced,discontinued,company_id) values ( 21,'colas9','1977-01-01',null,4);